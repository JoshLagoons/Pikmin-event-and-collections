...
namespace PikminCoupling
{
    ...
    public class Pikmin : Iobserver
    {
        ...
        internal int onThrowing;
        internal int onWhistle;
        ...
        public Action OnThrow { get; internal set; }
        public Action OnWhistle { get; internal set; }
        ...
        public void Update(object sender, OlimarState state)
        {
